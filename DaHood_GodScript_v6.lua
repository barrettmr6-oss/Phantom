--[[
▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
      DA HOOD  ·  NEXUS SCRIPT  ·  v6.0  [2026 EDITION]
   ═══════════════════════════════════════════════════════
...
-- CLEANUP
-- ══════════════════════════════════════════════════
for _, n in ipairs({"DaHoodGUI_v3","DaHoodGUI_v4","DaHoodGUI_v5","NexusGUI_v6","GodNotifs_v5","GodNotifs_v6"}) do
...
SG.Name="NexusGUI_v6"; SG.ResetOnSpawn=false; SG.ZIndexBehavior=Enum.ZIndexBehavior.Sibling; SG.IgnoreGuiInset=true; SG.Parent=LPGui
...
LogoLbl.BackgroundTransparency=1; LogoLbl.Text="◈  NEXUS v6"; LogoLbl.TextColor3=C.AccentGlow
...
SecHdr(p9,"─── PRESETS ───")
for _,pr in ipairs({"⭐ GOD","💀 GHOST","👑 KING","🔥 FLAME","💎 ELITE","🎯 REAPER","🧊 ICE","⚡ ZEUS","🌊 TIDAL","🔮 VOID","🐉 DRAGON","☠️ SKULL","🌙 LUNA","🦅 EAGLE","🏆 CHAMP","💠 NEXUS"}) do
...
CloseBtn.MouseButton1Click:Connect(function() W.Visible=false; S.GUIOpen=false; Notify("NEXUS","Closed. RShift to reopen.",3) end)
...
-- ══════════════════════════════════════════════════
task.wait(0.5);  Notify("NEXUS v6","✅ Loaded! 2026 Edition — Da Hood God Script",5,C.AccentGlow)
